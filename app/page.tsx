...
const products = [
  ['Monitor de signos vitales iM3', 'Edan', 'Monitoreo', 'ECG, SpO₂, presión no invasiva y temperatura en una interfaz compacta.', '/equipment/monitor-signos.webp'],
  ['Estetoscopio profesional Harvey', 'Welch Allyn', 'Diagnóstico', 'Acústica de doble cabezal para exploración clínica general.', '/equipment/estetoscopio.webp'],
  ['Autoclave de mesa T-Edge', 'Tuttnauer', 'Esterilización', 'Ciclos trazables y cámara eficiente para clínicas y consultorios.', '/equipment/autoclave.webp'],
  ['Monitor de paciente ePM', 'Mindray', 'Monitoreo', 'Visualización modular para atención crítica y recuperación.', '/equipment/monitor-paciente.webp'],
